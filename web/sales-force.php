    ...
    <h1 id="side-nav">Sales Force</h1>
      ...
      <div class="wp-area">
        ...
        <ul class="oracle-content">
          ...
          <li>Salesforce  setup, Configuration and Customization</li>
          <li>Maintenance and continued improvements</li>
          <li>Custom reports and dashboards </li>
          <li>Force Automation</li>
        </ul>
        <p>Benefits:</p>
        <ul class="oracle-content">
          ...
          <li>Mobile CRM Solutions</li>
          <li>Availability of self-service options</li>
          <li>Automated assignment and escalation</li>
