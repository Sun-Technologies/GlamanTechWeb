   ...
   <h1 class="page-title">Cloud</h1>
    ...
    <div id="microsoft-cloud">
      ...
      <div class="wp-area">
        ...
        <p>Microsoft Cloud online services include a fully integrated, cloud connected Office experience through Office 365, IaaS through Windows Azure, and system and device management through Windows Intune. </p>
        <p>We provide Microsoft cloud service to help you match your business and communication requirements, at the same time enabling easy expansion of your business.</p>
      </div>
    </div>
    <div id="sap-cloud">
      ...
      <ul class="oracle-content">
        ...
        <li>Expertise for technical application, database administration, and performance management</li>
        <li>cloud strategy, develop a transformation roadmap, execute your cloud migration, operate your hybrid cloud environment </li>
        <li>multiple layers of application protection</li>
        <li>Complete SAP product portfolio</li>
      </ul>
      </div>
    </div>
    <div id="amazon-cloud">
      ...
      <ul class="oracle-content">
        ...
        <li>Migration of data, application and content to AWS Cloud.</li>
