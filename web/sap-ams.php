...
<?php include'header.php'; ?>
  <div id="primary" class="container   clearfix animated bounceIn" style="padding-bottom: 4%;">
    <h1 id="side-nav">SAP AMS</h1>
       <hr/>
      <div class="wp-area">
        <p>Our innovative SAP AMS design help you in gaining access to cost-efficient, uninterrupted, flexible business operations to enhance your business growth and productivity.</p>
        ...
        <ul class="oracle-content">
          ...
          <li>Ongoing Improvement of SAP Solutions</li>
          <li>Incident Management</li>
          <li>Remote Supportability</li>
        ...
        <ul class="oracle-content">
          ...
          <li>Predictable and transparent costs</li>
          <li>Business scaling flexibility and agility</li>
        </ul>
      </div>
    </div>
