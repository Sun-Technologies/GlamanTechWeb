...
<?php include'header.php'; ?>
  <div id="primary" class="container   clearfix animated bounceIn" style="padding-bottom: 4%;">
    <h1 id="side-nav">Rapid Deployment Solution</h1>
       <hr/>
      <div class="wp-area">
        ...
        <ul class="oracle-content">
          ...
          <li>Pre-built content and validation rules for SAP Customer on Demand</li>
          <li>SAP Personnel Administration and Organizational Management RDS</li>
          <li>SAP Accelerated Learning RDS</li>
          <li>SAP Operational Headcount Planning RDS</li>
          <li>SAP Executive HR Reporting RDS</li>
          <li>SAP RDS GRC Access Control</li>
        ...
        <ul class="oracle-content">
          ...
          <li>Be hardware/platform vendor independent</li>
          <li>Pre-built integration leveraging</li>
          <li>Pre-defined scope, timeline and budget.</li>
          <li>Choice of deployment models</li>
        </ul>
      </div>
    </div>
